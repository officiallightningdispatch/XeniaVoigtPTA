  ...
  if(p==='/join'){
    ...
    <section class="section"><div class="container">
      <div class="modern-page-grid">
        <article class="modern-panel pop"><span class="mini-label">READY TO JOIN?</span><div class="modern-stat">YES</div><h2>Become a Xenia Voigt PTA member.</h2><p>Membership alone helps strengthen the PTA. Volunteer only when it works for you.</p><a class="btn primary" href="${joinUrl}" target="_blank" rel="noopener noreferrer" style="margin-top:16px">Join Xenia Voigt PTA ↗</a></article>
