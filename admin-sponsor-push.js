  ...
  async function render(){
    ...
    block.innerHTML=`
      ...
      <div class="admin-finance-grid">
        <div class="admin-finance-card"><strong>11</strong><span>targeted sponsor asks sent</span><small>DJ/MC, inflatable, Arts Integration, sensory support, printing/signage and student activities</small></div>
        ...
        <div class="admin-finance-card"><strong>5 days</strong><span>follow-up cadence</span><small>Re-contact nonresponders after five business days; do not duplicate same-day asks</small></div>
      </div>
      <div class="admin-role-list" style="margin-top:14px">
        <div class="admin-role-item"><span class="dot"></span><div><b>New outreach:</b> P&amp;B Print — donated/discounted printing or $250; Cool Arrow — $300 entertainment or $250 community support; Wyoming Springs Orthodontics — $195 inflatable or $250 community support.</div></div>
      ...
      <p style="margin-top:14px"><a class="admin-resource-link" href="${esc(TRACKER_URL)}" target="_blank" rel="noopener"><span>Open detailed sponsorship tracker<small>151-line needs budget + sponsor outreach log</small></span><span>↗</span></a></p>`;
    return true;
  }
  let attempts=0;
