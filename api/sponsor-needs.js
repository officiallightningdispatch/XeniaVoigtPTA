...
const NEEDS = [
  ...
  {id:'backup-candy',category:'Trunk-or-Treat',title:'Backup candy reserve',target:320,priority:'Critical',details:'Build a 4,000-piece backup candy reserve for Trunk-or-Treat so hosts can be replenished if needed.',fulfillment:'A+ Federal Credit Union repeat candy support is confirmed. Exact 2026 quantity/value is still being finalized; additional sealed candy support may still be useful until the reserve quantity is verified.',recognition:'Trunk-or-Treat supporter recognition on the website and applicable event signage.',coverageNote:'A+ Federal Credit Union candy support confirmed · exact quantity pending'},
