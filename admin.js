(()=>{
  ...
  const DRIVE={
    command:'https://drive.google.com/file/d/1pKoJgjf8p3IWH4bxokHFJ9yMK5ikjoQU/view',
  ...
  const roleData={
    ...
    'Vice President of Community Engagement & Special Events':{
      ...
      tasks:['Finalize campus layout and traffic flow','Lock DJ / PA / emcee direction','Close remaining food vendor and sponsor outreach','Coordinate Trunk-or-Treat, volunteers, signage, auction and family experience','Keep the Fall Festival Command Center current'],
  ...
  function loginScreen(message=''){
    main.innerHTML=`<section class="admin-shell"><div class="container admin-login"><div class="admin-login-card"><span class="mini-label">PTA BOARD ACCESS</span><h1>Board workspace</h1><p>Secure access for authorized Voigt PTA board members.</p><form id="adminLogin"><label>Username<input id="adminUsername" type="text" autocomplete="username" autocapitalize="none" required></label><label>Password<input id="adminPassword" type="password" autocomplete="current-password" required></label><button class="btn primary" type="submit">Sign in</button></form><div id="adminStatus" class="newsletter-status">${esc(message)}</div></div></div></section>`;
  ...
  function render(data,session){
    ...
    main.innerHTML=`<section class="admin-shell"><div class="container admin-dashboard" id="adminRoot">
      ...
      <div class="admin-section-title" style="margin-top:18px"><h2>Whole-event inventory</h2><p>Item-level confirmed / target from the 151-line master needs plan. This view starts with the highest-impact inventory; the full tracker remains the source of record.</p></div><div class="admin-table-card" style="overflow:auto"><table class="admin-table"><thead><tr><th>Area</th><th>Item</th><th>Coverage</th><th>Remaining</th><th>Priority</th></tr></thead><tbody><tr><td><b>Viking Quest</b><br><small>Welcome HQ</small></td><td>Quest pouches / favor bags</td><td><b>0 / 300</b> bags</td><td>300 bags</td><td>Critical</td></tr><tr><td><b>Viking Quest</b><br><small>Welcome HQ</small></td><td>Quest Cards</td><td><b>0 / 350</b> cards</td><td>350 cards</td><td>Critical</td></tr><tr><td><b>Viking Quest</b><br><small>Welcome HQ</small></td><td>Pouch labels / stickers</td><td><b>0 / 350</b> labels</td><td>350 labels</td><td>Nice-to-have</td></tr><tr><td><b>Viking Quest</b><br><small>Welcome HQ</small></td><td>Check-in table</td><td><b>0 / 2</b> tables</td><td>2 tables</td><td>Critical</td></tr><tr><td><b>Viking Quest</b><br><small>Welcome HQ</small></td><td>Tablecloths</td><td><b>0 / 2</b> cloths</td><td>2 cloths</td><td>Core</td></tr><tr><td><b>Viking Quest</b><br><small>Welcome HQ</small></td><td>Quest completion stamp</td><td><b>0 / 2</b> stamps</td><td>2 stamps</td><td>Critical</td></tr><tr><td><b>Viking Quest</b><br><small>All Stations</small></td><td>Station completion stamps / stickers</td><td><b>0 / 1800</b> marks</td><td>1800 marks</td><td>Critical</td></tr><tr><td><b>Viking Quest</b><br><small>All Stations</small></td><td>Queue cones / floor markers</td><td><b>0 / 30</b> markers</td><td>30 markers</td><td>Critical</td></tr><tr><td><b>Viking Quest</b><br><small>1 - Trial of Skill</small></td><td>Foam / Velcro axe sets</td><td><b>0 / 8</b> axes</td><td>8 axes</td><td>Critical</td></tr><tr><td><b>Viking Quest</b><br><small>1 - Trial of Skill</small></td><td>Hack-Silver coins</td><td><b>0 / 330</b> coins</td><td>330 coins</td><td>Critical</td></tr><tr><td><b>Viking Quest</b><br><small>2 - Shield Wall</small></td><td>Mini cardboard shield blanks</td><td><b>0 / 330</b> blanks</td><td>330 blanks</td><td>Critical</td></tr><tr><td><b>Viking Quest</b><br><small>2 - Shield Wall</small></td><td>Viking arm rings / bracelets</td><td><b>0 / 330</b> rings</td><td>330 rings</td><td>Critical</td></tr><tr><td><b>Viking Quest</b><br><small>3 - Rune Maker's Workshop</small></td><td>Wooden coin blanks</td><td><b>0 / 330</b> blanks</td><td>330 blanks</td><td>Critical</td></tr><tr><td><b>Viking Quest</b><br><small>3 - Rune Maker's Workshop</small></td><td>Metallic paint pens</td><td><b>0 / 30</b> pens</td><td>30 pens</td><td>Critical</td></tr><tr><td><b>Viking Quest</b><br><small>4 - Voigt Longship Builders</small></td><td>Construction/cardstock paper</td><td><b>0 / 400</b> pieces</td><td>400 pieces</td><td>Critical</td></tr><tr><td><b>Viking Quest</b><br><small>4 - Voigt Longship Builders</small></td><td>Dragon crew stickers/tattoos</td><td><b>0 / 330</b> each</td><td>330 each</td><td>Critical</td></tr><tr><td><b>Viking Quest</b><br><small>5 - Skald's Stage / Finish</small></td><td>Quest Complete shield tickets</td><td><b>0 / 330</b> tickets</td><td>330 tickets</td><td>Critical</td></tr><tr><td><b>Games & Carnival</b><br><small>All games</small></td><td>Small carnival prizes</td><td><b>0 / 600</b> prizes</td><td>600 prizes</td><td>Core</td></tr><tr><td><b>Games & Carnival</b><br><small>All games</small></td><td>Prize bags</td><td><b>0 / 300</b> bags</td><td>300 bags</td><td>Core</td></tr><tr><td><b>Photo Stop</b><br><small>Viking Harvest Wagon</small></td><td>Rustic wagon / garden cart</td><td><b>0 / 1</b> unit</td><td>1 unit</td><td>Critical</td></tr><tr><td><b>Photo Stop</b><br><small>Viking Harvest Wagon</small></td><td>Faux hay bales</td><td><b>0 / 6</b> bales</td><td>6 bales</td><td>Core</td></tr><tr><td><b>Photo Stop</b><br><small>Viking Harvest Wagon</small></td><td>Pumpkins/gourds</td><td><b>0 / 20</b> pieces</td><td>20 pieces</td><td>Core</td></tr><tr><td><b>Cake Walk</b><br><small>Cake Walk</small></td><td>Numbered floor spots</td><td><b>0 / 30</b> spots</td><td>30 spots</td><td>Critical</td></tr><tr><td><b>Cake Walk</b><br><small>Cake Walk</small></td><td>Cake/prize display tables</td><td><b>0 / 4</b> tables</td><td>4 tables</td><td>Critical</td></tr><tr><td><b>Cake Walk</b><br><small>Cake Walk</small></td><td>Cake boxes / carriers</td><td><b>0 / 30</b> boxes</td><td>30 boxes</td><td>Core</td></tr><tr><td><b>Sensory Retreat</b><br><small>Quiet Area</small></td><td>Soft seating / floor cushions</td><td><b>0 / 10</b> pieces</td><td>10 pieces</td><td>Critical</td></tr><tr><td><b>Sensory Retreat</b><br><small>Quiet Area</small></td><td>Noise-reducing headphones</td><td><b>0 / 8</b> pairs</td><td>8 pairs</td><td>Critical</td></tr><tr><td><b>Sensory Retreat</b><br><small>Quiet Area</small></td><td>Fidgets</td><td><b>0 / 30</b> pieces</td><td>30 pieces</td><td>Core</td></tr><tr><td><b>Trunk-or-Treat</b><br><small>All trunks</small></td><td>Candy reserve</td><td><b>0 / 8000</b> pieces</td><td>8000 pieces</td><td>Core</td></tr><tr><td><b>Trunk-or-Treat</b><br><small>All trunks</small></td><td>Non-food treat reserve</td><td><b>0 / 600</b> pieces</td><td>600 pieces</td><td>Core</td></tr><tr><td><b>Inflatables</b><br><small>Field</small></td><td>Inflatable rentals</td><td><b>0 / 3</b> units</td><td>3 units</td><td>Critical</td></tr><tr><td><b>Entertainment</b><br><small>Cafeteria/Stage</small></td><td>DJ/MC service</td><td><b>0 / 1</b> service</td><td>1 service</td><td>Critical</td></tr><tr><td><b>Food Court</b><br><small>Vendor Row</small></td><td>Vendor check-in packets</td><td><b>0 / 15</b> packets</td><td>15 packets</td><td>Critical</td></tr><tr><td><b>General</b><br><small>Campus-wide</small></td><td>Main entrance banner</td><td><b>0 / 1</b> banner</td><td>1 banner</td><td>Critical</td></tr><tr><td><b>General</b><br><small>Campus-wide</small></td><td>Zone signs</td><td><b>0 / 12</b> signs</td><td>12 signs</td><td>Critical</td></tr><tr><td><b>General</b><br><small>Campus-wide</small></td><td>Parking / traffic signs</td><td><b>0 / 12</b> signs</td><td>12 signs</td><td>Critical</td></tr><tr><td><b>General</b><br><small>Campus-wide</small></td><td>Volunteer water</td><td><b>0 / 96</b> bottles</td><td>96 bottles</td><td>Critical</td></tr><tr><td><b>General</b><br><small>Campus-wide</small></td><td>Volunteer snacks</td><td><b>0 / 60</b> servings</td><td>60 servings</td><td>Core</td></tr><tr><td><b>General</b><br><small>Campus-wide</small></td><td>Walkie-talkies</td><td><b>0 / 10</b> radios</td><td>10 radios</td><td>Critical</td></tr><tr><td><b>Prizes / Fundraiser</b><br><small>Silent Auction</small></td><td>Austin Aquarium family membership</td><td><b>1 / 1</b> donation</td><td>0 donation</td><td>Confirmed</td></tr><tr><td><b>Prizes / Fundraiser</b><br><small>Silent Auction</small></td><td>Austin Zoo tickets</td><td><b>4 / 4</b> tickets</td><td>0 tickets</td><td>Confirmed</td></tr><tr><td><b>Prizes / Fundraiser</b><br><small>Silent Auction</small></td><td>Round Rock Pumpkin Festival family pass</td><td><b>1 / 1</b> pass</td><td>0 pass</td><td>Confirmed</td></tr><tr><td><b>Prizes / Fundraiser</b><br><small>Silent Auction</small></td><td>Monster Mini Golf family 4-pack</td><td><b>1 / 1</b> package</td><td>0 package</td><td>Confirmed</td></tr><tr><td><b>Prizes / Fundraiser</b><br><small>Sweet Finish Giveaway</small></td><td>Cookies & Crumbles gift certificate</td><td><b>1 / 1</b> certificate</td><td>0 certificate</td><td>Confirmed</td></tr><tr><td><b>Prizes / Fundraiser</b><br><small>Family Prizes / Giveaways</small></td><td>Amy's Ice Creams gift certificates</td><td><b>0 / 4</b> certificates</td><td>4 certificates</td><td>Core</td></tr></tbody></table></div><nav class="admin-suite-tabs"><button class="active" data-panel="role">My Role</button><button data-panel="submissions">Forms & Applications</button><button data-panel="events">Events</button><button data-panel="finance">Finance</button><button data-panel="communications">Communications</button><button data-panel="resources">Drive Hub</button></nav>
    ...
    function renderSubmissions(kind){
      ...
      list.innerHTML=arr.length?arr.map(x=>{
        ...
        const statusClass=x.status==='approved'?'good':x.status==='reviewing'||x.status==='contacted'?'warn':x.status==='closed'?'':'hot';
        return `<article class="admin-entry" id="entry-${kind}-${x.id}"><div class="admin-entry-head"><div><div class="admin-entry-name">${esc(name||'Submission')}</div><div class="admin-entry-meta">${esc(x.email||'')}${x.phone?' · '+esc(x.phone):''}</div></div><div class="admin-entry-meta">${esc(sub||'')}</div><select data-status-id="${x.id}"><option value="new" ${x.status==='new'?'selected':''}>New</option><option value="reviewing" ${x.status==='reviewing'?'selected':''}>Reviewing</option><option value="approved" ${x.status==='approved'?'selected':''}>Approved</option><option value="contacted" ${x.status==='contacted'?'selected':''}>Contacted</option><option value="closed" ${x.status==='closed'?'selected':''}>Closed</option></select><button data-view-id="${x.id}">View details</button></div><div class="admin-entry-details"><div class="admin-field-grid"><div class="admin-field"><span class="field-label">Submitted</span><span class="field-value">${new Date(x.created_at).toLocaleString()}</span></div><div class="admin-field"><span class="field-label">Status</span><span class="field-value"><span class="admin-status-pill ${statusClass}">${esc(humanKey(x.status))}</span></span></div>${payloadFields(x.payload)}</div></div></article>`;
