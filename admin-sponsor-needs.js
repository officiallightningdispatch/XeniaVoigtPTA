(()=> {
  ...
  async function render(){
    ...
    el.innerHTML=`<div class="admin-section-title"><h2>Specific-need sponsorships</h2><p>Website selections flow here automatically. Only confirmed/paid amounts count toward public fulfillment totals.</p></div>
      ...
      <div class="admin-callout" style="margin-top:12px"><strong>Drive sync:</strong> these records are the live website source. Confirmed/paid totals sync to the dedicated Google Drive sponsorship tracker so pending selections never close a need prematurely. <a href="https://docs.google.com/spreadsheets/d/1Uy_sdelXl_bGrhT38p-b_DjEJ2EQ1TDNMVfqHxDs3kw/edit" target="_blank" rel="noopener">Open live sponsorship sheet ↗</a></div>`;
